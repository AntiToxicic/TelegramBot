...
public class STATISTIC_ActionCommand : ActionCommand
{
    public STATISTIC_ActionCommand(IMediator mediator, Statuses status, string command) : base(mediator, status, command)
    {
    }
    ...
    public override async Task Execute(Update update)
    {
        ...
        await Mediator.Send(new SendUserStatisticCommand(
